...
#if COP
  bool if_debug;
  DataArrayScalar species;
  DataArray2d Hia;
  DataArray2d Hib;
  // DataArray2d Omega_table;
  // DataArrayOne T_star;
  // DataArrayOne delta_star;
  HydroParams(DataArrayScalar species,
              // DataArray2d Omega_table,
              // DataArrayOne T_star,
              // DataArrayOne delta_star,
              DataArray2d Hia,
              DataArray2d Hib) : nStepmax(0), tEnd(0.0), nOutput(0),
                                 enableOutput(true), mhdEnabled(false), nlog(10),
                                 nx(0), ny(0), nz(0), ghostWidth(3), nbvar(5), dimType(TWO_D),
                                 ...
                                 Hia(Hia), Hib(Hib){};
#endif
  HydroParams() : nStepmax(0), tEnd(0.0), nOutput(0), enableOutput(true), mhdEnabled(false),
                  nlog(10),
