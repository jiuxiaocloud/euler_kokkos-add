...
namespace euler_kokkos
{
  ...
  // =======================================================
  // =======================================================
  SolverBase::SolverBase(HydroParams &params, ConfigMap &configMap) : params(params),
                                                                      configMap(configMap),
                                                                      solver_type(SOLVER_UNDEFINED)
  {
    ...
    m_variables_names[IU] = "rho_u"; // momentum component X
    m_variables_names[IV] = "rho_v"; // momentum component Y
    m_variables_names[IW] = "rho_w"; // momentum component Z
#if COP
    // NOTE：Output 变量设置
    m_variables_names[IDY1] = "rho_y1";
#endif
  ...
  // =======================================================
  // =======================================================
  int SolverBase::should_save_solution()
  {
