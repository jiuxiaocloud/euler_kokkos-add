...
namespace euler_kokkos
{
  ...
  struct EulerEquations<2>
  {
     ...
     */
    static KOKKOS_INLINE_FUNCTION void convert_to_primitive(const HydroState &q,
                                                            HydroState &w,
                                                            real_t gamma0)
    {
     ...
     */
    static KOKKOS_INLINE_FUNCTION void flux_x(const HydroState &q, real_t p, HydroState &flux)
    {
      flux[ID] = q[IU];                       // rho u
     ...
     */
    static KOKKOS_INLINE_FUNCTION void flux_y(const HydroState &q, real_t p, HydroState &flux)
    {
      flux[ID] = q[IV];                       // rho v
     ...
     */
    static KOKKOS_INLINE_FUNCTION void flux_visc_x(const GradTensor &g,
                                                   const Vector &v,
                                                   const Vector &f,
                                                   real_t mu,
                                                   HydroState &flux)
     ...
     * as in ASH / CHORUS code.
     */
    static KOKKOS_INLINE_FUNCTION void flux_visc_y(const GradTensor &g,
                                                   const Vector &v,
                                                   const Vector &f,
                                                   real_t mu,
                                                   HydroState &flux)
     ...
     */
    template <int dir>
    static KOKKOS_INLINE_FUNCTION void cons_to_charac(HydroState &data,
                                                      const HydroState &q,
                                                      const real_t c,
                                                      const real_t gamma0)
    {
     ...
     */
    template <int dir>
    static KOKKOS_INLINE_FUNCTION void charac_to_cons(HydroState &data,
                                                      const HydroState &q,
                                                      const real_t c,
                                                      const real_t gamma0)
    {
  ...
  struct EulerEquations<3>
  {
     ...
     * \param[out] flux \f$ (\rho v, \rho v u, \rho v^2+p, \rho v w, v(E+p) ) \f$
     */
    static KOKKOS_INLINE_FUNCTION void flux_z(const HydroState &q, real_t p, HydroState &flux)
    {
      real_t w = q[IW] / q[ID];
     ...
     * as in ASH / CHORUS code.
     */
    static KOKKOS_INLINE_FUNCTION void flux_visc_z(const GradTensor &g,
                                                   const Vector &v, const Vector &f,
                                                   real_t mu,
                                                   HydroState &flux)
    {
