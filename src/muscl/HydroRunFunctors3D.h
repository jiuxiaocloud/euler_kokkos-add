  ...
  namespace muscl
  {
    ...
    public:
      ...
      ComputeDtFunctor3D(HydroParams params,
                         DataArray3d Udata) : HydroBaseFunctor3D(params),
                                              Udata(Udata){};
    ...
    public:
      ...
      ConvertToPrimitivesFunctor3D(HydroParams params,
                                   DataArray3d Udata,
                                   DataArray3d Qdata) : HydroBaseFunctor3D(params), Udata(Udata), Qdata(Qdata){};
    ...
    public:
      ...
      ComputeAndStoreFluxesFunctor3D(HydroParams params,
                                     ...
                                     VectorField3d gravity) : HydroBaseFunctor3D(params),
                                                              Qdata(Qdata),
    ...
    public:
      ...
      UpdateFunctor3D(HydroParams params,
                      ...
                      DataArray3d FluxData_x,
                      DataArray3d FluxData_y,
                      DataArray3d FluxData_z) : HydroBaseFunctor3D(params),
                                                Udata(Udata),
                                                FluxData_x(FluxData_x),
                                                FluxData_y(FluxData_y),
                                                FluxData_z(FluxData_z){};
    ...
    public:
      ...
      UpdateDirFunctor3D(HydroParams params,
                         DataArray3d Udata,
                         DataArray3d FluxData) : HydroBaseFunctor3D(params),
                                                 Udata(Udata),
                                                 FluxData(FluxData){};
    ...
    public:
      ...
      ComputeSlopesFunctor3D(HydroParams params,
                             ...
                             DataArray3d Slopes_z) : HydroBaseFunctor3D(params), Qdata(Qdata),
    ...
    public:
      ...
      ComputeTraceAndFluxes_Functor3D(HydroParams params,
                                      ...
                                      real_t dt,
                                      bool gravity_enabled,
                                      VectorField3d gravity) : HydroBaseFunctor3D(params), Qdata(Qdata),
                                                               Slopes_x(Slopes_x), Slopes_y(Slopes_y), Slopes_z(Slopes_z),
                                                               Fluxes(Fluxes),
                                                               dt(dt),
    ...
    public:
      ...
      GravitySourceTermFunctor3D(HydroParams params,
                                 ...
                                 VectorField3d gravity,
                                 real_t dt) : HydroBaseFunctor3D(params),
                                              Udata_in(Udata_in),
                                              Udata_out(Udata_out),
                                              gravity(gravity),
                                              dt(dt){};
