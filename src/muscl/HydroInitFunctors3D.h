  ...
  namespace muscl
  {
    ...
    public:
      InitFakeFunctor3D(HydroParams params,
                        DataArray3d Udata) : HydroBaseFunctor3D(params), Udata(Udata){};
    ...
    public:
      InitImplodeFunctor3D(HydroParams params,
                           ...
                           DataArray3d Udata) : HydroBaseFunctor3D(params), iparams(iparams), Udata(Udata){};
    ...
    public:
      InitBlastFunctor3D(HydroParams params,
                         BlastParams bParams,
                         DataArray3d Udata) : HydroBaseFunctor3D(params), bParams(bParams), Udata(Udata){};
    ...
    public:
      ...
      void operator()(const int &index) const
      {
        ...
        Udata(i, j, k, IP) = p / (gamma0 - 1.0) +
                             0.5 * (Udata(i, j, k, IU) * Udata(i, j, k, IU) + Udata(i, j, k, IV) * Udata(i, j, k, IV) + Udata(i, j, k, IW) * Udata(i, j, k, IW)) / Udata(i, j, k, ID);
